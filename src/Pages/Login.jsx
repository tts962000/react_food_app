...
export default function Login() {
  ...
  return (
    ...
    <form  className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={signInHandler}>
    <h1 className='mb-3 text-2xl text-blue-500 font-bold'>Login Form</h1>
      <div className="mb-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
        {loading && <svg aria-hidden="true" className="mr-3 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
